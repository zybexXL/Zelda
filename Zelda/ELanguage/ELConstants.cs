...
namespace Zelda
{
    public enum ELFunctions
    {
        ...
        StackCount, TrackNumber, Translate, TVInfo,
        Min, Max, Avg, Sum,
        // string manipulation
        ...
        Right, Swap, Trim, TrimLines, UnMoveArticles, Unswap, NoArticles, URLify,
        // test and comparison
    ...
    public class ELConstants
    {
        public static readonly List<ELFunction> ELFunctionWiki = new List<ELFunction>()
        {
            ...
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Counter, "Counts upwards in specified increments", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Counter"),
            ...
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Number, "Returns the first number , including decimals, from a given string", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Number"),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Rand, "Returns a random number between two given numbers", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Rand"),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Range, "Creates a semi-colon delimited list of numbers in a field", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Range"),
            ...
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.StackCount, "Returns the number of files in a stack", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#StackCount"),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.TrackNumber, "Returns a file's track # value", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#TrackNumber"),
            ...
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Min, "Returns the minimum value of a series of values", null),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Max, "Returns the maximum value of a series of values", null),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Avg, "Returns the average value of a series of values", null),
            new ELFunction(ELCategory.Miscellaneous, ELFunctions.Sum, "Returns the sum of a series of values", null),
            ...
            new ELFunction(ELCategory.Math, ELFunctions.Math, "Evaluates a given mathematical formula", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.abs, "Returns the absolute value of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.sign, "Returns the sign of x (1 when x >= 0, -1 when x < 0)", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.log, "Returns the natural logarithm (base e) of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.log10, "Returns the common logarithm (base 10) of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.pow, "Returns x raised to the y-th power", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.randn, "Returns a random value ranging between -x and x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.equal, "Returns 1 when x = y, 0 otherwise", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.below, "Returns 1 when x < y, 0 otherwise", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.above, "Returns 1 when x > y, 0 otherwise", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.Int, "Returns the integer portion of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.frac, "Returns the fractional portion of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.round, "Returns x rounded to the nearest whole number", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.trunc, "Returns x truncated to n decimal places", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.atan, "Returns the arctangent of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.cos, "Returns the cosine of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.sin, "Returns the sine of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.tan, "Returns the tangent of x", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.abscos, "Returns the absolute value of cosine(x)", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
            new ELFunction(ELCategory.Math, ELFunctions.abssin, "Returns the absolute value of sin(x)", "https://wiki.jriver.com/index.php/Miscellaneous_Functions#Math"),
        };
    } 
}
