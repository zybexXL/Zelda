...
namespace Zelda
{
    ...
    public class ELConstants
    {
        public static readonly List<ELFunction> ELFunctions = new List<ELFunction>()
        {
            ...
            new ELFunction(ELCategory.Identifier, "IsDriveMissing", "Returns true if the File cannot be accessed", "https://wiki.jriver.com/index.php/Test_and_Comparison_Functions#IsDriveMissing"),
            ...
            new ELFunction(ELCategory.TestCompare, "IsDigit", "Tests a value to check if it's numeric", "https://wiki.jriver.com/index.php/Test_and_Comparison_Functions#IsDigit"),
            ...
            new ELFunction(ELCategory.TestCompare, "IsLowerCase", "Tests a value to check if it's all in lower case", "https://wiki.jriver.com/index.php/Test_and_Comparison_Functions#IsLowerCase"),
            new ELFunction(ELCategory.TestCompare, "IsUpperCase", "Tests a value to check if it's all in upper case", "https://wiki.jriver.com/index.php/Test_and_Comparison_Functions#IsUpperCase"),
